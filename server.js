...
console.log("Saved to db.json. Content: ", newNote);
res.json(savedNotes);
...
app.delete("/api/notes/:id", function(req, res) {
  ...
  let newID = 0;
  console.log(`Deleting note ID ${noteID}`);  // the deleted note (currNote) must recieve a new id of zero because its !important. 
